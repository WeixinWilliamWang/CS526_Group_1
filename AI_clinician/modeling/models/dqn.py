...
class PERAgent:
    ...
    def __init__(self, obs_space_dim, action_space_dim, learning_rate=3e-4, gamma=0.99, tau=0.01, lambda_=0.1, max_reward=15, buffer_size=10000, batch_size=64):
        ...
        # hard copy models parameters to target models parameters
    ...
    def from_state_dict(data):
        ...
        agent.model.load_state_dict(data["models"])
        agent.target_model.load_state_dict(data["models"])
        return agent
...
class DuelingDQNModel(BaseModel):
    ...
    def _build_autoencoder(self, train_states, val_states):
        ...
        for epoch in range(self.n_state_epochs):
            model_dict = {"models": self.autoencoder}
            ...
            if new_loss["models"] > last_loss:
                print("Early stopping")
                break
            last_loss = new_loss["models"]
    ...
    def load(cls, filepath):
        ...
        assert model_data['model_type'] == 'DuelingDQNModel', 'Invalid models type for DuelingDQNModel'
