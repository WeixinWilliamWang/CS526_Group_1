...
class SOTAModel(BaseModel):
    ...
    def save(self, filepath, metadata=None):
        """
        Saves the models as a pickle to the given filepath.
        """
        model_data = {
    ...
    def load_state_model(self, checkpoint_path):
        """
        Loads a SOTA models from a checkpoint path (generated by the rl_representations
        source code).
        """
    ...
    def load_policy(self, checkpoint_path):
        """
        Loads a DiscreteBCQ models from a checkpoint path (generated by the
    ...
    def load(cls, filepath, device='cpu'):
        """
        Loads a models from a pickle file at the given filepath.
        """
        model_data = torch.load(filepath, map_location=device)
        assert model_data['model_type'] == 'SOTAModel', 'Invalid models type for SOTAModel'
...
if __name__ == '__main__':
    # models = SOTAModel('RNN')
    # models.load_from_checkpoint('/Users/vsivaram/Documents/research/icu/rl_representations/data/results/rnn_s64_l1e-4_rand25_sepsis/rnn_checkpoints/checkpoint.pt')
    # models.save("/Users/vsivaram/Documents/research/icu/AI-Clinician-MIMICIV/data/sota_models/rnn.pt")
