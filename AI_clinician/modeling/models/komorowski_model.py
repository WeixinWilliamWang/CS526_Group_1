...
class AIClinicianModel(BaseModel):
    ...
    def compute_physician_probabilities(self, X=None, states=None, actions=None, soften=True):
        ...
        physician policy, which is learned using the same state clustering models
        as the AI Clinician.
    ...
    def load(cls, filepath):
        ...
        assert model_data['model_type'] == 'AIClinicianModel', 'Invalid models type for AIClinicianModel'
