...
if __name__ == '__main__':
    ...
    parser.add_argument('--models-type', dest='model_type', type=str, default='AIClinician',
    ...
    all_model_stats = []
    max_wis_lb = 0 # Save the best models with value > 0
    min_wis_lb = 1e9 # Also save the worst models
