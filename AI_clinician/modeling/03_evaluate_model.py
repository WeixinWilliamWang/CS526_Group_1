...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description=('Evaluates an AI Clinician models on the MIMIC-IV test set.'))
    parser.add_argument('--data', type=str,
                        help='Model data directory (should contain train and test directories)', default='../data/model_data/')
    parser.add_argument('--model', type=str,
                        help='Path to pickle file containing the models', default='../data/model_data/models/model_params/best_model.pkl')
    parser.add_argument('--out', dest='out_path', type=str, default='../output',
