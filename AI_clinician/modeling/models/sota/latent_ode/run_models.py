...
# Generative models for noisy data based on ODE
...
parser.add_argument('--latent-ode', action='store_true', help="Run Latent ODE seq2seq models")
parser.add_argument('--z0-encoder', type=str, default='odernn', help="Type of encoder for Latent ODE models: odernn or rnn")
...
parser.add_argument('--rnn-vae', action='store_true', help="Run RNN baseline: seq2seq models with sampling of the h0 and ELBO loss.")

parser.add_argument('-l', '--latents', type=int, default=6, help="Size of the latent state")
parser.add_argument('--rec-dims', type=int, default=20, help="Dimensionality of the recognition models (ODE or RNN).")
...
if __name__ == '__main__':
	...
	#Load checkpoint and evaluate the models
