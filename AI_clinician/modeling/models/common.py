...
def transform_actions(input_amounts, vaso_doses, cutoffs):
    ...
    n_bins = len(input_cutoffs) - 1  # Number of bins (5), not number of cutoffs (6)
    return (
        n_bins * (np.digitize(input_amounts, input_cutoffs) - 1) +
...
def build_record_sequences_with_policies(qldata3, predicted_actions, physpol, n_cluster_states, soften_factor=0.01):
    """
    Creates a copy of the given qldata3 containing softened physician and models
